...
const albums = [
  ...
  },
  {
    ...
    description: "„The New Order” to przełomowy album Testament i jedno z najważniejszych wydawnictw thrash metalu końca lat 80. Płyta łączy agresję i techniczność z melodyjnymi partiami gitar i charakterystycznym wokalem Chucka Billy’ego. Brzmienie jest potężne, a utwory takie jak “Into the Pit” czy “Disciples of the Watch” pokazują siłę i precyzję zespołu w najlepszej formie. Testament udowadnia tu, że potrafi tworzyć muzykę równie intensywną co Metallica czy Megadeth, zachowując przy tym własny, niepowtarzalny styl. „The New Order” to klasyk, który ugruntował pozycję zespołu wśród gigantów thrash metalu.",
    totalDuration: "45:22"
  }
];
